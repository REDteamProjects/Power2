...
public class HelpPageScript : MonoBehaviour
{
	...
	void Start ()
	{
        ...
        manual_0.transform.localScale = new Vector3(1f, 0.45f, 1);
        manual_0.transform.localPosition = new Vector3(0, -400, 0);
	...
	void Update ()
	{
	    ...
	    switch (touch.Phase)
	    {
	        ...
	        case TouchPhase.Moved:
                ...
                {
                    if (mainStartPos.y + deltaY > 1448)
                        baseY = 1448;
                    else if (mainStartPos.y + deltaY < 200)
                        baseY = 200;
                    else
